...
void loadStruct(const char * fileName, imgAttributes *img){
...
float compareRed(imgAttributes img1, imgAttributes img2) {
	float result = 0;
...
float compareGreen(imgAttributes img1, imgAttributes img2) {
	float result = 0;
...
float compareBlue(imgAttributes img1, imgAttributes img2) {
	float result = 0;
